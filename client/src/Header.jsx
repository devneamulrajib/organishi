...
export default function Header() {
  ...
  /* collapse on route change — restore full view */
    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        /* Mobile: pill goes full-width, nav stacks vertically */
        @media (max-width: 640px) {
          ...
          .hdr-logo { font-size: 16px !important; }
      ...
      >
        ...
        >
          ...
          >
            {/* Logo */}
            <Link to="/" style={{ textDecoration: 'none', flexShrink: 0, marginRight: 20 }}>
              <span
                className="hdr-logo"
                style={{
            ...
            {/* Desktop nav — ALWAYS visible, collapses only when collapsed=true */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0, marginLeft: 'auto' }}>
              ...
              {/* Gold dot — only shows when collapsed */}
              <AnimatePresence>
                {collapsed && (
                  <motion.div
          ...
          {/* ── Mobile nav — vertical stack, always open on mobile ── */}
          <div
                ...
                >
                  ...
                  {isActive(href) && (
                    <div style={{
                      ...
                      background: '#c8a96e', boxShadow: '0 0 6px #c8a96e99',
                    }} />
                  )}
                </motion.div>
              </Link>
